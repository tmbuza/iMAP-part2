...
# Using Mothur Pipeline {#mothur-workflow}
...
### OTU tidy table or shared file
```{r}
library(tidyverse)
mo_otutable <- read_tsv("data/final.opti_mcc.shared", show_col_types = FALSE) %>% 
...
saveRDS(mo_otutable, "RDataRDS/mo_taxonomy.rds")
```

### Preprocessing tidy taxonomy table
```{r}  
...
head(mo_taxonomy)[1:3,] %>% as.data.frame()  
